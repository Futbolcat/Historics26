...
const URL_LOGO_TORNEO = "img/LogoTHFC_100.png";
const URL_CLUB = "https://files.fcf.cat/escudos/clubes/escudos/00100_0000577607_martinenc-200x200.png";
...
window.onload = function() { 
  ...
  document.getElementById("imgClub").src = URL_CLUB;
...
function detectarMiembro() {
  ...
  var htmlFicha = '<div style="margin-top: 25px; padding: 20px; background: #f8f9fa; border: 2px solid #CF2732; border-radius: 8px; max-width: 500px; margin-left: auto; margin-right: auto; text-align: center;">';
...
function completarDatosFicha(nombreJugador) {
  ...
  if (datosP && datosP.length > 0) {
    for (var j = 0; j < datosP[0].length; j++) {
      ...
      tablaHtml += '<tr style="border-bottom: 1px solid #CF2732;">';
